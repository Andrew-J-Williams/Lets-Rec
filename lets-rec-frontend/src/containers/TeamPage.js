...
class TeamPage extends React.Component {
    ...
    render(){
        ...
        } else if (teamObject.location === "Philadelphia"){
        ...
        } else if (teamObject.location === "San Antonio"){
        ...
        } else if (teamObject.location === "Seattle"){
                        ...
                        {teamObject.users.map(user => {
                            return(
                                <div key={user.id} className="team-user-div">
                                    <Link to={`/users/${user.id}`}><img src={user.picture} className="team-user-pic" alt="user-pic"/></Link>
